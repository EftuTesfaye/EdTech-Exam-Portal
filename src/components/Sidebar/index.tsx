...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  >
    <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <span className="bg-white text-black py-2 px-4 rounded">
        Admin Portal
      </span>
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/selectplainquestion"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
Select Plain Question                           </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="/viewplainquestions"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
View Plain Question                           </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="/selectCourse"
...
Select Course                          </NavLink>
                          ...
                          <li>
                            <NavLink
                              to="/selectgroupedquestion"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
Select Grouped Question                           </NavLink>
                          </li>
                        </ul>
                      </div>
                    </React.Fragment>
